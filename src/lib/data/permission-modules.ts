...
export const PERMISSION_MODULES: Record<PermissionTabKey, PermissionModuleDef[]> = {
  umum: [
    ...
    { key: 'pengajuan-barang', module: 'pengajuan_barang', label: 'Pengajuan Barang' },
  ...
  approval: [
    ...
    { key: 'approval-pengajuan-barang', module: 'pengajuan_barang', label: 'Pengajuan Barang (Bagian GA)' },
  ],

  laporan: [
    { key: 'laporan', module: 'laporan', label: 'Semua Laporan (Inventaris, Barang Masuk/Keluar, Retur, Stock Opname, Rekap Data)' },
  ],
  sistem: [
